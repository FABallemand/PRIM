...
\begin{table}[]
    ...
    \hline
    Codec     & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Energy\\ {[}mJ/frame{]}\end{tabular}} & \multicolumn{1}{c|}{PSNR} & \multicolumn{1}{c|}{\begin{tabular}[c]{@{}c@{}}Bit rate\\ {[}bpp{]}\end{tabular}} \\ \hline
    JPEG      & 843.39                                                                               & 26.65                     & 0.33                                                                              \\ \hline
    JPEG 2000 & 2894.59                                                                              & 70.00                     & 13.45                                                                             \\ \hline
    PNG       & 2642.24                                                      & 70.00                     & 13.51                                                                             \\ \hline
    Webp      & 663.84                                                                               & 29.15                     & 0.30                                                                              \\ \hline
    \end{tabular}
    \caption[Consumed energy, \acrshort{psnr} and bit rate for different codecs.]{Consumed energy, \acrshort{psnr} and bit rate for different codecs.}
    \label{tab_codecs}
\end{table}
