...
\begin{figure}[H]
    \centering
    \subfloat[Our networks]{{\includegraphics[width=8.5cm]{img/balle_bdpsnr_1a.png} \label{bdpsnr_1:a}}}
    \subfloat[Pre-trained networks]{{\includegraphics[width=8.5cm]{img/balle_bdpsnr_1b.png} \label{bdpsnr_1:b}}}
...
\begin{figure}[H]
    \centering
    \subfloat[Our networks]{{\includegraphics[width=8.5cm]{img/balle_bdpsnr_2a.png} \label{bdpsnr_2:a}}}
    \subfloat[Pre-trained networks]{{\includegraphics[width=8.5cm]{img/balle_bdpsnr_2b.png} \label{bdpsnr_2:b}}}
