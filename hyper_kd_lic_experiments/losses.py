...
class KDLoss(nn.Module):
    ...
    def __init__(self, kd_l_lmbda, kd_hl_lmbda, kd_o_lmbda, o_lmbda, rd_lmbda):
        super().__init__()
        ...
        self.o_criterion = RateDistortionLoss(lmbda=rd_lmbda, metric="mse") # Output criterion

    def __str__(self):
        s = (
            f"{self.kd_l_lmbda} * {self.kd_l_criterion} + "
            f"{self.kd_hl_lmbda} * {self.kd_hl_criterion} + "
            f"{self.kd_o_lmbda} * {self.kd_o_criterion} + "
    ...
    def forward(
        ...
        loss = (self.kd_l_lmbda * kd_l_loss
                ...
                + self.o_lmbda * o_loss["loss"])
        loss_dict = {
            "loss": loss,
            "latent_kd_loss": kd_l_loss,
            "hyper_latent_kd_loss": kd_hl_loss,
            "output_kd_loss": kd_o_loss,
            "output_loss": o_loss["loss"],
            "mse_loss": o_loss["mse_loss"],
            "bpp_loss": o_loss["bpp_loss"]
        }
