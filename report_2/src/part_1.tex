...
\begin{figure}[H]
    \centering
    \subfloat[Our networks]{{\includegraphics[width=8.5cm]{img/bdpsnr_1.png} \label{bdpsnr_1:a}}}
    \subfloat[Pre-trained networks]{{\includegraphics[width=8.5cm]{img/bdpsnr_2.png} \label{bdpsnr_1:b}}}
