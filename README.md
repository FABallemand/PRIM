...
- As discussed with tutors, it should also be possible to apply knowledge distillation on the hyper-latent space. This is what is done in `hyper_kd_lic_experiments`.
