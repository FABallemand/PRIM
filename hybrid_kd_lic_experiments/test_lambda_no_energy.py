...
output_folder = f"/home/ids/fallemand-24/PRIM/hybrid_kd_lic_experiments/test_res/{time_stamp}"
...
# RD loss pre-trained teacher quality r,d=1,5, student KD with RD loss, latent and hyper latent loss MSE, 64 channels) lmbda=(0.2, 0.2, 0.2, 0.4, 0.025)
lmbdas = [0.025]
ids = [336202]
...
for name, id_ in zip(networks.keys(), ids):
    if name == "teacher":
        ...
        net = ScaleHyperprior(N_student, N_teacher_r, M)
